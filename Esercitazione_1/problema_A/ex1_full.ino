/*  MATTEO CAROLEO S5216938
    ...
    This sketch manipulates input signal in pin A0. By changing values
    in the "ex1_config.h" file, it can:
      ...
      - Filter a signal with runing sum algorithm
    ...
    The extensive use of the preprocessor directives is for maximizing the waste of 
    memory  
*/
...
//does not create array for sampling if in test mode
#ifndef TEST
...
// if EX_FULL is defined, the part below won't run
...
void Plot_quantized_and_filtered_signals (double* sig_src_arr, int sig_length){
  double temp4 [sig_length];
  double temp8 [sig_length];
